...
def predict(varA, varB):
    ...
    st.write(st.session_state['ship'].type, st.session_state['ship'].gross_tonnage, st.session_state['ship'].length, st.session_state['ship'].beam, st.session_state['ship'].draft, st.session_state['ship'].speed)
